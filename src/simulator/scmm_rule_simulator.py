...
from src.policy.scmm_rule import compute_scmm_quotes_inventory_only
from src.portfolio.portfolio import Portfolio
from src.utils.logger import SimulationLogger


class SCMRuleSimulator:
    ...
    def run(self) -> pd.DataFrame:
        ...
        for step in range(1, self.num_steps + 1):
            ...
            r_as, delta_as, u_skew, u_spr, bid, ask = compute_scmm_quotes_inventory_only(
                S=S,
                q=self.portfolio.inventory,
                gamma=p.gamma,
                sigma=p.sigma,
